...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2024 at 08:04 AM
...
(3, 'foto buah', 'buah buahan segar', '2024-04-19', 4),
(4, 'bunga', 'foto bunga', '2024-04-19', 4),
(5, 'minuman', 'foto minuman', '2024-04-19', 4);
...
(2, 'buah apel', 'warna merah', '2024-04-19', '618813321_buah (5).jpg', 3, 4),
(3, 'buah jeruk', 'wana orange', '2024-04-19', '1130236639_buah (3).jpg', 3, 4);
...
--
ALTER TABLE `likefoto`
  ADD CONSTRAINT `likefoto_ibfk_1` FOREIGN KEY (`likeid`) REFERENCES `foto` (`fotoid`) ON DELETE CASCADE ON UPDATE CASCADE,
